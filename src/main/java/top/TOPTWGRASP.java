...
/*!
 *  \author  Carlos González Mendoza 
 *  \brief   Clase TOPTWGRASP del programa.
 *  
 *  En este fichero se encuentra la clase TOPTWGRASP del programa.
 */

public class TOPTWGRASP {
 public final static double NO_EVALUATED = -1.0;
    
    private TOPTWSolution solution;
    private int solutionTime;
    private Random r = new Random();  // SecureRandom is preferred to Random
